 ...
 * File Color.kt
 * ============
 * Definisi warna menggunakan tema Hijau sesuai Latihan Tambahan.
 */
...
val Secondary = Color(0xFFFF8F00)        // Amber/Oranye
val SecondaryDark = Color(0xFFFF6F00)    // Amber gelap
